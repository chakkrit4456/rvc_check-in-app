-- Complete Final Fix for RVC App & Admin Panel
-- This script fixes all issues and creates a fully working system
...
-- 3. Grant all privileges to authenticated users
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO authenticated;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO authenticated;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public TO authenticated;

-- 4. Clear existing data to start fresh
...
-- 6. Insert classrooms with proper naming (ปวช.1/1, ปวช.2/3, ปวส.1/2, etc.)
DO $$
DECLARE
    dept_id UUID;
    dept_name VARCHAR;
...
-- 14. Create view for dashboard stats
...
-- 17. Test admin profile lookup
SELECT * FROM profiles WHERE email = 'chakkritnb1123@gmail.com';

-- 18. Test student profile lookup
