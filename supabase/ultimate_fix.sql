-- Ultimate Fix for RVC App & Admin Panel
-- This script fixes all issues and creates proper classroom structure
...
-- 5. Insert classrooms with proper naming (ปวช.1/1, ปวช.2/3, ปวส.1/2, etc.)
DO $$
DECLARE
    dept_id UUID;
    dept_name VARCHAR;
