-- EMERGENCY FIX - Complete Database Reset
-- This script completely fixes all RLS and database issues
...
-- 4. GRANT ALL PRIVILEGES TO ANON USERS (for testing)
...
-- 19. TEST STUDENT PROFILE LOOKUP
SELECT * FROM profiles WHERE student_id = '1234567890';

-- 20. SHOW CLASSROOM STRUCTURE
SELECT 
